...
.events(v-t9n.deep="'docs'")
  ...
  Alert(type="warning" show-icon) Будьте внимательны
    span(slot="desc") Не используйте `return false` в асинхронных обработчиках. Все обработчики, которые могут предотвращать действия, должны быть синхронными

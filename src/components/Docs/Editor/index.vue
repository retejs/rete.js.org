...
.editor
  ...
  p Создайте экземпляр 
    i NodeEditor
  Code(lang="javascript" source="editorInstance")
  ...
  Code(lang="javascript" source="toJson")
  p Данные имеют следующую структуру:
  Code(lang="javascript" source="dataStructure")
  ...
  Code(lang="javascript" source="fromJson")
